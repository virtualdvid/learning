...
Sub main()
    ...
    Set data = Application.InputBox("Select Training Data Set", "Get Range", Type:=8)
    w1 = Rnd()
    w2 = Rnd()
    b = Rnd()
    ...
    For i = 1 To Range("D8").Value
        ...
        ActiveWorkbook.Sheets(2).Range("E" & i + 1).Value = i
        ActiveWorkbook.Sheets(2).Range("F" & i + 1).Value = point(2)
        ActiveWorkbook.Sheets(2).Range("G" & i + 1).Value = Pred
